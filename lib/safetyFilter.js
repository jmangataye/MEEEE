...
// Message de repli FIXE (jamais généré par le modèle) envoyé au fan quand le
// filtre bloque une réponse — garantit qu'aucun texte à risque ne peut partir
// même dans ce cas de secours.
const FALLBACK_MESSAGE = 'dame un momentito, ya te ayudo con eso 🙏';

module.exports = { reviewOutgoingText, reviewOfferInput, FALLBACK_MESSAGE };
